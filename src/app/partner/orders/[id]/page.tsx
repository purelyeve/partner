...
export default async function PartnerOrderDetailPage({
  ...
  return (
    <div className="space-y-6">
      ...
      {!distributor.easypost_api_key_last4 && pendingShip && (
        <Alert variant="warning">
          Add your EasyPost API key under{' '}
          <Link href="/partner/payments">Payments</Link> before buying a customer label.
        </Alert>
      )}
      ...
      {pendingShip && (
        <Card className="space-y-4">
          <h2 className="text-lg">Fulfillment</h2>
